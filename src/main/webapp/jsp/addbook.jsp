	...
	<div class="row d-flex justify-content-center">
		<div class="col-xl-10 col-lg-8 col-md-9 col-11 text-center">
			<div class="card" style="margin-top: 30px; margin-bottom: 30px;">
				...
				<form:form action="addbooks" class="form-card" method="post"
					...
					<div class="row justify-content-between text-left my-4">
						<div class="form-group col-sm-6 flex-column d-flex">
							...
							<form:input class="form-control" type="number" id="bookId"
								name="bookId" path="bookId" placeholder="Enter the Book Id"
								onblur="validate(1)" />
					...
					<div class="row justify-content-between text-left my-4">
						<div class="form-group col-sm-6 flex-column d-flex">
							...
							<form:input type="text" id="bookAuthor" name="bookAuthor"
								path="bookAuthor" placeholder="Enter the Book Author Name"
								onblur="validate(3)" />
 ...
 --%>						</div>
					...
					<div class="row justify-content-between mt-2">
						<div class="form-group col-lg-12 text-center">
							<a href="/bookLists"><button
									class="btn btn-primary rounded-pill px-3" type="submit">Submit</button></a>
							<a href="/bookLists"><button
